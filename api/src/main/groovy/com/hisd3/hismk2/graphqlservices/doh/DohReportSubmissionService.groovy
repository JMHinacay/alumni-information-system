...
class DohReportSubmissionService {
    ...
    GraphQLRetVal<HospitalOperationsDeathsDTO> submitHospitalOperationsDeaths(@GraphQLArgument(name = "year") Integer year) {
        ...
        def ndrDenominator = deaths.totalDischarged - deaths.deathsDto.totalDeathLessThan48
        def ndrNumerator = deaths.deathsDto.totalDeaths - deaths.deathsDto.totalDeathLessThan48
