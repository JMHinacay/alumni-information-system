...
""", PaymentTrackerDetails.class)
    ...
    PaymentTracker addPaymentMisc(
        ...
        totalpayments = (totalCash + totalCheck + totalCard + totalDeposit)

        paymentTracker.totalpayments = totalpayments
        paymentTracker.hosp = totalpayments
        paymentTracker.pf = pf

        paymentTracker.change = totalpayments - (totalCash + totalCheck + totalCard + totalDeposit)
        ...
        if (type == "OR") {
            ...
            paymentTracker.description = "OR [${paymentTracker.ornumber}] - ${arRemarks}"
        ...
        miscTarget.each {
            map ->
                ...
                def amount = new BigDecimal(map.get("amount"))
