...
class GroupPolicyService {
	...
	@Autowired
	private com.backend.gbp.repository.GroupPolicyRepository groupPolicyRepository
	...
	GroupPolicy getGroupPolicyById(@GraphQLArgument(name = "groupPolicyId") UUID id) {
		return groupPolicyRepository.findById(id).get()
	}
