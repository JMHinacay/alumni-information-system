...
import { Drawer, Button, List, Row, Col, Affix, Typography, Card, Modal, PageHeader } from 'antd';
          ...
          <Col md={24}>
            <div>
              <List
                ...
                bordered={false}
                itemLayout={'vertical'}
                dataSource={selectedEmployeeByDept}
                renderItem={(item) =>
                  !_.isEmpty(item.data) && (
                    <>
                      <List.Item>
                        <PageHeader
                          ...
                          title={<Typography.Title level={4}>{item.department}</Typography.Title>}
                        ></PageHeader>
                        <HRTable
                          preserveSelectedRowKeys={true}
                          size="small"
