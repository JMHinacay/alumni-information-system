...
const AccumulatedLogsSummary = ({ pageData, allowReallocateHours }) => {
  ...
  return (
    <Table.Summary.Row>
      <Table.Summary.Cell index={0} width={300}>
      ...
      {allowReallocateHours && (
        <>
          <Table.Summary.Cell index={42} align="center" width={120}>
            <Typography.Text strong>
              <NumeralFormatter format={'0,0.[0000]'} withPesos={false} value={totalUnallocated} />
            </Typography.Text>
          </Table.Summary.Cell>
          <Table.Summary.Cell index={43} align="center" width={120}></Table.Summary.Cell>
        </>
      )}
    </Table.Summary.Row>
  );
