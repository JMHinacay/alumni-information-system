...
const useContextLazyQuery = (query, options = {}, dependencies = [], propertyNames = {}) => {
  ...
  const lazyQuery = (finalOptions = {}, finalDependencies = [], finalPropertyNames = {}) => {
    ...
    return queryFunction(finalOptions);
  };

  return [lazyQuery, result];
};

export default useContextLazyQuery;
